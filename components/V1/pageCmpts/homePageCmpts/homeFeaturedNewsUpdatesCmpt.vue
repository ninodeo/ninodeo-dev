...
<template>
  <section>
    ...
    <div class="defaultContainer py-10 flex flex-col gap-10">
      ...
      <div class="flex justify-end">
        <NuxtLink to="/whats-new" class="link link-primary hover:underline p-5 font-semibold block py-3">See More Articles</NuxtLink>
      </div>
